 ...
 * @module PostgresV3
 */
export type SpinPostgresV3ValueBoolean = {
    tag: 'boolean';
    val: boolean;
};
export type SpinPostgresV3ValueInt8 = {
    tag: 'int8';
    val: number;
};
export type SpinPostgresV3ValueInt16 = {
    tag: 'int16';
    val: number;
};
export type SpinPostgresV3ValueInt32 = {
    tag: 'int32';
    val: number;
};
export type SpinPostgresV3ValueInt64 = {
    tag: 'int64';
    val: bigint;
};
export type SpinPostgresV3ValueFloating32 = {
    tag: 'floating32';
    val: number;
};
export type SpinPostgresV3ValueFloating64 = {
    tag: 'floating64';
    val: number;
};
export type SpinPostgresV3ValueStr = {
    tag: 'str';
    val: string;
};
export type SpinPostgresV3ValueBinary = {
    tag: 'binary';
    val: Uint8Array;
};
...
export type SpinPostgresV3ValueTimeStamp = {
    tag: 'timestamp';
    val: bigint;
};
export type SpinPostgresV3ValueDbNull = {
    tag: 'db-null';
};
export type SpinPostgresV3ParameterValue = SpinPostgresV3ValueBoolean | SpinPostgresV3ValueInt8 | SpinPostgresV3ValueInt16 | SpinPostgresV3ValueInt32 | SpinPostgresV3ValueInt64 | SpinPostgresV3ValueFloating32 | SpinPostgresV3ValueFloating64 | SpinPostgresV3ValueStr | SpinPostgresV3ValueBinary | SpinPostgresV3ValueDate | SpinPostgresV3ValueTime | SpinPostgresV3ValueDateTime | SpinPostgresV3ValueTimeStamp | SpinPostgresV3ValueDbNull;
export type PostgresV3ParameterValue = SpinPostgresV3ParameterValue | number | bigint | boolean | null | Uint8Array | string;
export declare enum PostgresV3DataType {
...
export interface PostgresV3RowSet {
    ...
    rows: {
        [key: string]: number | boolean | bigint | null | string | Uint8Array | Date;
    }[];
}
export type PostgresV3DbBoolean = {
    tag: 'boolean';
    val: boolean;
};
export type PostgresV3DbInt8 = {
    tag: 'int8';
    val: number;
};
export type PostgresV3DbInt16 = {
    tag: 'int16';
    val: number;
};
export type PostgresV3DbInt32 = {
    tag: 'int32';
    val: number;
};
export type PostgresV3DbInt64 = {
    tag: 'int64';
    val: number;
};
export type PostgresV3DbFloating32 = {
    tag: 'floating32';
    val: number;
};
export type PostgresV3DbFloating64 = {
    tag: 'floating64';
    val: number;
};
export type PostgresV3DbStr = {
    tag: 'str';
    val: string;
};
export type PostgresV3DbBinary = {
    tag: 'binary';
    val: Uint8Array;
};
export type PostgresV3DbDate = {
    tag: 'date';
    val: [number, number, number];
};
...
export type PostgresV3DbTimeastamp = {
    tag: 'timestamp';
    val: bigint;
};
export type PostgresV3DbNull = {
    tag: 'db-null';
};
export type PostgresV3DbUnsupported = {
    tag: 'unsupported';
};
export type RdbmsDbValue = PostgresV3DbBoolean | PostgresV3DbInt8 | PostgresV3DbInt16 | PostgresV3DbInt32 | PostgresV3DbInt64 | PostgresV3DbFloating32 | PostgresV3DbFloating64 | PostgresV3DbStr | PostgresV3DbBinary | PostgresV3DbDate | PostgresV3DbTime | PostgresV3DbDateTime | PostgresV3DbTimeastamp | PostgresV3DbNull | PostgresV3DbUnsupported;
